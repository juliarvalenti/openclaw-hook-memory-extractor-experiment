...
echo ""
echo "Output files:"
echo "  ~/.openclaw/conversation-extractor.log          (optimized)"
echo "  ~/.openclaw/conversation-extractor-verbose.log  (full raw, opt-in)"
echo ""
echo "Restart the gateway to activate:"
echo "  openclaw gateway stop && openclaw gateway"
echo ""
echo "To enable verbose mode (untruncated thinking + full raw entries):"
echo "  OPENCLAW_EXTRACTOR_VERBOSE=1 openclaw gateway"
